...
@implementation GJDKCoreDBManager

+ (id)sharedCoreDBManagerInstance {
    static GJDKCoreDBManager *sharedManagerInstance = nil;
...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"GJDKCoreDataBaseManager"];
